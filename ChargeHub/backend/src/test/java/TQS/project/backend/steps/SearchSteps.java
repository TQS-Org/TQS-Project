...
public class SearchSteps {
    ...
    public void i_should_see_a_list_of_ev_charging_stations() {
        ...
        Assertions.assertFalse(cards.isEmpty(), "Expected to see a list of EV charging stations, but found none.");
    }
    ...
    public void i_click_the_search_button(String buttonText) {
        WebElement searchButton = driver.findElements(By.tagName("button")).stream()
    ...
    public void i_should_see_only_stations_in_district(String expectedDistrict) {
        ...
        for (WebElement card : cards) {
            ...
            Assertions.assertTrue(text.contains(expectedDistrict.toLowerCase()),
