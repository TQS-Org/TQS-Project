...
public class CreateOperatorSteps {
    ...
    public void i_click_on_create_operator() {
        WebElement button = driver.findElements(By.className("create-card"))
                .stream()
    ...
    public void i_should_see_success_modal(String expectedMessage) {
        WebElement modal = wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("success-animation")));
